...
Реализуем класс Heap на основе динамического массива состоящего из elem. Конструктор класса преобразует обычный массив из elem в Heap. Методы класса: siftdown, siftup, getsize, add, popmax, showmax.
Считаем исходный массив в новый массив A состоящий из elem.
Создадим кучу(H) на первых k элементах массива A. Выведем максимальный элемент из кучи H. Далее в цикле будем добавлять следующий элемент из A в H. Далее будем проверять:
если индекс максимального элемента кучи H лежит в окне, выведем значение максимального элемента, если индекс максимального элемента вне окна, то удалим этот максимальный элемент из кучи и повторим этот алгоритм.
В итоге мы будем выводить только максимальный элемент из окна. Значит, в конце концов программа выведет все требуемые максимумы.*/
